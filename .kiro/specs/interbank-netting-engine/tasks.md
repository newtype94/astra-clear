...
- [x] 4.3 속성 테스트 작성 - 신용 잔액 조회 정확성

  - **속성 4: 신용 잔액 조회 정확성**
  - **검증: 요구사항 2.4**

- [x] 4.4 속성 테스트 작성 - 신용 토큰 추적성

  - **속성 5: 신용 토큰 추적성**
  - **검증: 요구사항 2.5**

- [x] 5. 상계(Netting) 엔진 구현
- [x] 5.1 주기적 상계 트리거 구현
...
- [x] 5.7 속성 테스트 작성 - 상계 완료 후 상태 업데이트

  - **속성 10: 상계 완료 후 상태 업데이트**
  - **검증: 요구사항 4.4, 4.5**

- [x] 6. Relayer 시스템 구현
- [x] 6.1 Besu 이벤트 모니터링 구현
